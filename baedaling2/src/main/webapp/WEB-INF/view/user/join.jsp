...
<link rel="stylesheet" href="<%=cp%>/resource/css/join.css" type="text/css">
 <div id="container_join">
		...
		<div id="body_line">
		<form id="" name="joinform" method="post">
			<table>
				<tr class="etch_list1">
				...
				<tr class="etch_list2">
					<td class="inputinfo_tr"><input type="text" class="input_normal" id="zip" name="zip" style="width: 270px; margin-right: 10px;" readonly="readonly"><button type="button" class="city_search_btn" onclick="daumPostcode();">주소검색</button></td>
				</tr>
				<tr class="etch_list2">
